...
from cortstim.edp.objects.clinical.clinical_object import ClinicalScalpMeta, ClinicalPatientMeta, \
    ClinicalDatasetMeta
from cortstim.edp.utils.clinical import expand_channels
